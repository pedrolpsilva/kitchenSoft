...
export const ItemStatusModal: React.FC<ItemStatusModalProps> = ({
 ...
 <button
 onClick={onClose}
 className="p-1 rounded text-zinc-400 transition-colors"
 >
 <X size={20} />
 </button>
 </div>
 ...
 <button
 onClick={onClose}
 className="flex-1 h-14 bg-zinc-700 rounded font-sans font-bold text-base text-gray-50 transition-colors"
 >
 CANCELAR
 </button>

 <button
 onClick={() => onConfirm(item, targetStatus)}
