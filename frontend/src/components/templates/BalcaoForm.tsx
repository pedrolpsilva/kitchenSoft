...
const ProductSidebar: React.FC<ProductSidebarProps> = ({
 ...
 /* Count how many times each product name appears in active orders */
...
/* --- BalcaoForm Template --- Kitchen Soft ----------------------- */
...
export const BalcaoForm: React.FC = () => {
 ...
 /* Generate display ID on mount and when origin changes */
 ...
 /* Add product by double clicking on sidebar item */
 ...
 // 1. If an item with exact name already exists, increment quantity
 ...
 // 2. If an empty item slot exists, populate it
 ...
 /* -- Modifier (Observações) Management -- */
 ...
 /* Commit the counter after successful send */
 ...
 {/* Row: Display ID (readonly) + Origin */}

 <div className="grid grid-cols-2 gap-4">

 {/* Display ID - auto & immutable */}
 ...
 font-sans text-xs font-medium text-zinc-500 
